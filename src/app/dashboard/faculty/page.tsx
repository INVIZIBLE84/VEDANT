    ...
    React.useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                 ...
                 const myDocs = await getDocuments({ uploaderId: currentUser.id });
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-primary">Welcome, {user.name}!</h1>
             <p className="text-muted-foreground">Your central hub for managing classes, approvals, and documents.</p>
